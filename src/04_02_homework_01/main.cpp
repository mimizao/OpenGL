 ...
 * https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/4.3.textures_exercise1/textures_exercise1.cpp*/
#include <glad/glad.h>
...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "04_01_textures", nullptr, nullptr);
    if (window == nullptr)
    {
